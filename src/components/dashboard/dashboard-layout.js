...
const sidebarItems = [
  ...
  { name: "Bookings", href: "/dashboard/bookings", icon: CalendarToday },
  { name: "Chats", href: "/dashboard/chats", icon: Chat },
  { name: "Wallet", href: "/dashboard/wallet", icon: AccountBalance },
  { name: "Astrologers", href: "/astrologers", icon: Star },
